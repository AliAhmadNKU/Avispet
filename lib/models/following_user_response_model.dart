class FollowingUserResponseModel {
  FollowingUserResponseModel({
      num? status, 
      bool? error, 
      String? message, 
  ...
  FollowingUserResponseModel.fromJson(dynamic json) {
    _status = json['status'];
    _error = json['error'];
    ...
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(FollowingUserModel.fromJson(v));
      });
    }
  ...
  bool? _error;
  String? _message;
  List<FollowingUserModel>? _data;
  dynamic _metadata;
FollowingUserResponseModel copyWith({  num? status,
  bool? error,
  String? message,
  List<FollowingUserModel>? data,
  dynamic metadata,
}) => FollowingUserResponseModel(  status: status ?? _status,
  error: error ?? _error,
  ...
  List<FollowingUserModel>? get data => _data;
...
class FollowingUserModel {
  ...
  FollowingUserModel.fromJson(dynamic json) {
    _id = json['id'];
    ...
    _following = json['following'] != null ? FollowingUser.fromJson(json['following']) : null;
  ...
  num? _followingCount;
  FollowingUserModel copyWith({  num? id,
  num? followerId,
  num? followingId,
  String? status,
  String? createdAt,
  ...
  FollowingUser? get following => _following;
...
class FollowingUser {
  ...
  FollowingUser.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
