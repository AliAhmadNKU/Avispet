      ...
      if (event is GetCreatePostEvent) {
        ...
        await Future.delayed(Duration.zero, () async {
          Map<String, dynamic> mapData = {
            "opening_closing_hour":event.openingCloseHour,
            ...
            'small_dogs': event.smallDogs,
            'big_dogs': event.bigDogs,
            'child': event.child,
            'all_dogs': event.allDogs,
            'dog_leash': event.dogLeash,
            'green_spaces': event.greenSpaces,
